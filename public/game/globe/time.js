...
(function() {
    ...
    try {
        ...
        if (directionalLight !== undefined && window.directionalLight === undefined) {
                ...
                try {
                    ...
                    timeDisplay.innerHTML = `
                        ...
                        <div class="time-controls">
                            <button id="slowDown" onclick="slowDownTime()">◀</button>
                            <button id="pauseTime" onclick="toggleTimePause()">❚❚ Pause</button>
                            <button id="speedUp" onclick="speedUpTime()">▶</button>
                            <div id="speedDisplay">1x (Real Time)</div>
                        </div>
                        <div class="calendar-shortcuts">
                            <button onclick="jumpToSeason('spring')">Spring</button>
                            <button onclick="jumpToSeason('summer')">Summer</button>
                            <button onclick="jumpToSeason('fall')">Fall</button>
                            <button onclick="jumpToSeason('winter')">Winter</button>
                        </div>
                    `;
