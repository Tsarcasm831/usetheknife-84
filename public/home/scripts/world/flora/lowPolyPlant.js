...
/**
 * Creates and places a GLB-based Low Poly Plant at a specified grid location.
 ...
 */
export function createLowPolyPlant(scene, gridX = 77, gridZ = 96) {
    ...
    return loadModel('/assets/static/flora/low_poly_plant_0502171950_refine.glb')
        .then(gltf => {
            const plant = SkeletonUtils.clone(gltf.scene);
            plant.name = 'LowPolyPlant';
        ...
        .catch(err => console.error('Failed to load low_poly_plant GLB:', err));
}
