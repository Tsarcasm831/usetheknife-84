...
/**
 * Creates and places a GLB-based Muta Plant 2 at a specified grid location.
 ...
 */
export function createMutaPlant2(scene, gridX = 77, gridZ = 96) {
    ...
    return loadModel('/assets/static/flora/muta-plant2.glb')
        .then(gltf => {
            const plant = SkeletonUtils.clone(gltf.scene);
            plant.name = 'MutaPlant2';
        ...
        .catch(err => console.error('Failed to load muta-plant2.glb:', err));
}
