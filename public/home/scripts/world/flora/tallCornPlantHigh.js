...
/**
 * Creates and places a GLB-based Tall Corn Plant at a specified grid location.
 ...
 */
export function createTallCornPlantHigh(scene, gridX = 77, gridZ = 96) {
    ...
    return loadModel('/assets/static/flora/tall_corn_plant_high_0502172145.glb')
        .then(gltf => {
            const plant = SkeletonUtils.clone(gltf.scene);
            plant.name = 'TallCornPlantHigh';
        ...
        .catch(err => console.error('Failed to load tall_corn_plant_high GLB:', err));
    }
